...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
	...
	public DatabaseHelper(Context context){
		...
		Log.i(DatabaseHelper.class.getName(), "tried creating the database");
	}
	...
	public void onCreate(SQLiteDatabase arg0, ConnectionSource arg1) {
		try {
			...
			TableUtils.createTable(connectionSource, WaitLane.class);
	...
	public void onUpgrade(SQLiteDatabase db, ConnectionSource connectionSource, int oldVersion,
		...
		try {
			...
			TableUtils.dropTable(connectionSource, WaitLane.class, true);
	...
	public RuntimeExceptionDao<WaitLane, String> getWaitLaneDataDAO() {
		...
		return waitLaneRuntimeDAO;
	}
	
	@Override
	public void close() {
		super.close();
		waitLaneRuntimeDAO = null;
	}
}
